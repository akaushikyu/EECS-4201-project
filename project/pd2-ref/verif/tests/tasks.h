...
task check_D;
  ...
  begin : check_D_func
    ...
    t[31:0] = dut.core.`PROBE_F_PC;
    t[63:32] = dut.core.`PROBE_F_INSN;
    t[159:128] = dut.core.`PROBE_D_PC;
    t[166:160] = dut.core.`PROBE_D_OPCODE;
    t[171:167] = dut.core.`PROBE_D_RD;
    t[176:172] = dut.core.`PROBE_D_RS1;
    t[181:177] = dut.core.`PROBE_D_RS2;
    t[184:182] = dut.core.`PROBE_D_FUNCT3;
    t[191:185] = dut.core.`PROBE_D_FUNCT7;
    t[223:192] = dut.core.`PROBE_D_IMM;
    //$sformat(msg, "%h", t);
    //res = 1;
    if(
